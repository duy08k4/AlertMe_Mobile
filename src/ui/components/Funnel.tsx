    ...
    return (
        <motion.div
            ...
            <motion.div
                ...
                <div className="px-mainTwoSidePadding flex items-center-safe gap-1.5 pb-2.5 border-b border-b-lightGray">
                                ...
                                {section.options.map(option => {
                                    ...
                                    return (
                                        <span
                                            ...
                                            className={`flex w-full !border-[0.5px] border-lightGray ${isSelected && "bg-mainRed"} rounded-small px-2.5 py-2 cursor-pointer`}
                                        >
                ...
                <div className="px-mainTwoSidePadding flex items-center-safe gap-2.5">
                    ...
                    <button
                        className="flex-1 text-csNormal text-white font-medium bg-mainRed !py-2.5"
