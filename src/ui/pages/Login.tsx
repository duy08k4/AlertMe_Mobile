                ...
                <div className="relative z-10 h-full flex flex-col justify-center">
                    <div className="flex flex-col gap-7 px-4">
                        ...
                        <span className="w-full flex flex-col items-center text-center">
                            ...
                            <h1 className="leading-none! text-4xl text-mainDark font-bold">Đăng nhập</h1>
                            <p className="text-csMedium text-gray-500">Vui lòng đăng nhập để tiếp tục</p>
                        </span>
                        ...
                        <span className="flex items-center justify-center">
                            <p className="text-csNormal">
                                Chưa có tài khoản?{" "}
                                <Link to={routeConfig.register.root} className="text-mainRed! font-medium underline italic">
                                    Đăng ký
                                </Link>
                            </p>
                        </span>
